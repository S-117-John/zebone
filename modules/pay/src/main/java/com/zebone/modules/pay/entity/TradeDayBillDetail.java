 ...
 * @version 2020-12-09
 */
@Table(name="biz_trade_day_bill_detail", alias="a", columns={
		@Column(name="id", attrName="id", label="id", isPK=true),
		@Column(name="bill_amount", attrName="billAmount", label="交易笔数"),
		...
		@Column(name="product_name", attrName="productName", label="产品名称"),
...
public class TradeDayBillDetail extends DataEntity<TradeDayBillDetail> {
	
	private static final long serialVersionUID = 1L;
	private String billAmount;		// 交易笔数
	...
	public TradeDayBillDetail() {
		this(null);
	}

	public TradeDayBillDetail(String id){
		super(id);
	}
