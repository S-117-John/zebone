 ...
 * @version 2020-12-09
 */
@Table(name="biz_trade_month_bill_detail", alias="a", columns={
		@Column(name="id", attrName="id", label="id", isPK=true),
		@Column(name="bill_amount", attrName="billAmount", label="订单金额"),
		@Column(name="bill_no", attrName="billNo", label="账号"),
		...
		@Column(name="product_name", attrName="productName", label="商品名称"),
...
public class TradeMonthBillDetail extends DataEntity<TradeMonthBillDetail> {
	
	private static final long serialVersionUID = 1L;
	private String billAmount;		// 订单金额
	private String billNo;		// 账号
	...
	public TradeMonthBillDetail() {
		this(null);
	}

	public TradeMonthBillDetail(String id){
		super(id);
	}
