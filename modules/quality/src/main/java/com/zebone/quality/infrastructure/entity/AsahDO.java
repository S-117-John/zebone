...
public class AsahDO extends DataEntity{
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '手术名称与ICD-9-CM-3亚目编码'")
    private String asah_6_1_2;
    @Column(columnDefinition = "varchar(64) COMMENT '其它手术名称'")
    private String asah_6_1_2_1;
    @Column(columnDefinition = "varchar(64) COMMENT '是否实施开颅手术术中安全监测措施'")
    private String asah_7_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '安全监测措施选择'")
    private String asah_7_1_2;
    @Column(columnDefinition = "varchar(64) COMMENT '其它安全监测措施'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '是否为特殊类型的急性aSAH患者'")
    private String asah_9_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '患者类型的选择'")
    private String asah_9_1_2;
    @Column(columnDefinition = "varchar(64) COMMENT '开颅术后是否预防使用抗癫痫药物'")
    private String asah_9_2_1;
    @Column(columnDefinition = "varchar(64) COMMENT '抗癫痫药物选择'")
    private String asah_9_2_2;
    @Column(columnDefinition = "varchar(64) COMMENT '其它抗癫痫药物'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT 'aSAH术后特指并发症'")
    private String asah_10_2_2;
    @Column(columnDefinition = "varchar(64) COMMENT '其它aSAH术后特指并发症'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '手术后再手术原因'")
    private String asah_10_4_2;
    @Column(columnDefinition = "varchar(64) COMMENT '其它手术后再手术原因'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '是否为术前Hunt-Hess分级 1-2级的患者'")
    private String asah_12_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '出院前是否实施mRS评分'")
    private String asah_12_1_2;
    @Column(columnDefinition = "varchar(64) COMMENT '出院前mRS评估'")
    private String asah_12_1_4;
    @Column(columnDefinition = "double COMMENT '出院前mRS评分值'")
    private Double asah_12_1_3;
    @Column(columnDefinition = "varchar(64) COMMENT '是否有重点护理评估和健康教育'")
