...
public class KneeDO extends DataEntity{
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '预防深静脉栓塞医嘱执行时间'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '机械预防措施医嘱执行日期'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '预防性地给予药物医嘱执行日期'")
