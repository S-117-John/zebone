...
public class Tn implements Serializable {
    ...
    @JSONField(name="TN-1-1-2")
    private String tn_1_1_2;
    @JSONField(name="TN-1-1-2-1")
    private String tn_1_1_2_1;
    @JSONField(name="TN-1-2-1")
    private String tn_1_2_1;
    @JSONField(name="TN-1-2-2")
    private String tn_1_2_2;
    @JSONField(name="TN-1-2-3")
    private String tn_1_2_3;
    @JSONField(name="TN-1-2-4")
    private String tn_1_2_4;
    @JSONField(name="TN-1-2-4-1")
    private String tn_1_2_4_1;
    @JSONField(name="TN-1-2-5")
    private String tn_1_2_5;
    @JSONField(name="TN-1-3-1")
    private String tn_1_3_1;
    @JSONField(name="TN-1-3-2")
    private String tn_1_3_2;
    @JSONField(name="TN-1-3-2-1")
    private String tn_1_3_2_1;
    @JSONField(name="TN-1-3-3")
    private String tn_1_3_3;
    @JSONField(name="TN-1-4-1")
    private String tn_1_4_1;
    @JSONField(name="TN-1-4-2-1")
    private String tn_1_4_2_1;
    @JSONField(name="TN-1-4-2-2")
    private Double tn_1_4_2_2;
    @JSONField(name="TN-1-4-2-3")
    private Double tn_1_4_2_3;
    @JSONField(name="TN-1-4-2-4")
    private Double tn_1_4_2_4;
    @JSONField(name="TN-1-4-2-5")
    private Double tn_1_4_2_5;
    @JSONField(name="TN-1-4-2-6")
    private Double tn_1_4_2_6;
    @JSONField(name="TN-1-4-3")
    private String tn_1_4_3;
    @JSONField(name="TN-2-1-1")
    private String tn_2_1_1;
    @JSONField(name="TN-2-1-2")
    private String tn_2_1_2;
    @JSONField(name="TN-2-1-3")
    private String tn_2_1_3;
    @JSONField(name="TN-2-1-3-1")
    private String tn_2_1_3_1;
    @JSONField(name="TN-2-1-4")
    private String tn_2_1_4;
    @JSONField(name="TN-2-1-4-1")
    private String tn_2_1_4_1;
    @JSONField(name="TN-2-1-5")
    private String tn_2_1_5;
    @JSONField(name="TN-2-1-5-1")
    private String tn_2_1_5_1;
    @JSONField(name="TN-2-2-1")
    private String tn_2_2_1;
    @JSONField(format = "yyyy-MM-dd HH:mm",name = "TN-2-2-2")
    private Date tn_2_2_2;
    @JSONField(format = "yyyy-MM-dd HH:mm",name = "TN-2-2-3")
    private Date tn_2_2_3;
    @JSONField(name="TN-2-2-4")
    private String tn_2_2_4;
    @JSONField(name="TN-2-2-5")
    ...
    @JSONField(name="TN-5-1-1")
    private String tn_5_1_1;
    @JSONField(name="TN-5-1-2")
    private String tn_5_1_2;
    @JSONField(name="TN-5-1-3")
    private String tn_5_1_3;
    @JSONField(name="TN-5-1-4")
    private String tn_5_1_4;
    @JSONField(name="TN-6-1-1")
    private String tn_6_1_1;
    @JSONField(name="TN-6-1-2")
    private Double tn_6_1_2;
    @JSONField(name="TN-6-1-3")
    private String tn_6_1_3;
    @JSONField(name="TN-6-1-3-1")
    private String tn_6_1_3_1;
    @JSONField(name="TN-6-1-4")
    private Double tn_6_1_4;
    @JSONField(name="TN-6-2-1")
    private Double tn_6_2_1;
    @JSONField(name="TN-6-2-2")
    private String tn_6_2_2;
    @JSONField(name="TN-6-2-2-1")
    private String tn_6_2_2_1;
    @JSONField(name="TN-6-2-3")
    private Double tn_6_2_3;
    @JSONField(name="CM-7-1-1")
    private String cm_7_1_1;
    @JSONField(name="CM-7-1-2")
