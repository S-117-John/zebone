 ...
 */
package com.zebone.quality.modules.vsd.entity;
 ...
 * @version 2021-01-20
 */
@Table(name="quality_vsd", alias="a", columns={
		...
		@Column(name="vsd_1_1_1", attrName="vsd_1_1_1", label="是否实施手术前的超声心动图评估"),
		@Column(name="vsd_1_1_2", attrName="vsd_1_1_2", label="左室射血分数", comment="左室射血分数（LVEF）测量值"),
		@Column(name="vsd_1_1_3", attrName="vsd_1_1_3", label="室间隔缺损手术缺损分型"),
		@Column(name="vsd_1_1_4", attrName="vsd_1_1_4", label="VSD是否多发"),
		@Column(name="vsd_1_2_1", attrName="vsd_1_2_1", label="是否实施手术前的心导管检查评估"),
		@Column(name="vsd_1_2_2_1", attrName="vsd_1_2_2_1", label="肺循环血量"),
		@Column(name="vsd_1_2_2_2", attrName="vsd_1_2_2_2", label="体循环血量"),
		@Column(name="vsd_1_2_2", attrName="vsd_1_2_2", label="肺循环血量/体循环血量比值", comment="肺循环血量/体循环血量比值(QP/QS)"),
		@Column(name="vsd_2_1_1", attrName="vsd_2_1_1", label="室间隔缺损手术缺损手术适应证"),
		@Column(name="vsd_2_1_1_1", attrName="vsd_2_1_1_1", label="其他室间隔缺损手术适应证"),
		@Column(name="vsd_2_1_2", attrName="vsd_2_1_2", label="手术方法的选择"),
		@Column(name="vsd_2_1_2_1", attrName="vsd_2_1_2_1", label="其他手术方法"),
		@Column(name="vsd_3_1_1", attrName="vsd_3_1_1", label="是否使用体外循环"),
		@Column(name="vsd_3_1_2", attrName="vsd_3_1_2", label="起始日期时间"),
		@Column(name="vsd_3_1_3", attrName="vsd_3_1_3", label="终止日期时间"),
		@Column(name="vsd_3_2_1_1", attrName="vsd_3_2_1_1", label="术中是否再次阻断主动脉"),
		@Column(name="vsd_3_2_1", attrName="vsd_3_2_1", label="术中使用经食道超声"),
		@Column(name="vsd_3_2_1_2", attrName="vsd_3_2_1_2", label="是否存在残余分流"),
		@Column(name="vsd_3_3_1", attrName="vsd_3_3_1", label="是否围术期使用血制品"),
		@Column(name="vsd_3_3_2", attrName="vsd_3_3_2", label="其中:全血量", comment="其中:全血量(ml)"),
		@Column(name="vsd_3_3_3", attrName="vsd_3_3_3", label="其中:红细胞量", comment="其中:红细胞量(ml)"),
		@Column(name="vsd_3_3_4", attrName="vsd_3_3_4", label="其中:血浆量", comment="其中:血浆量(ml)"),
		@Column(name="vsd_3_3_5", attrName="vsd_3_3_5", label="其中:血小板量", comment="其中:血小板量(ml)"),
		@Column(name="vsd_3_3_6", attrName="vsd_3_3_6", label="临床用血总量", comment="临床用血总量(ml)"),
		@Column(name="vsd_3_4_1", attrName="vsd_3_4_1", label="是否实施术后机械通气"),
		@Column(name="vsd_3_4_2", attrName="vsd_3_4_2", label="起始日期时间"),
		@Column(name="vsd_3_4_3", attrName="vsd_3_4_3", label="终止日期时间"),
		...
		@Column(name="vsd_5_1_1", attrName="vsd_5_1_1", label="是否有术后活动性出血或血肿"),
		@Column(name="vsd_5_1_2", attrName="vsd_5_1_2", label="术后活动性出血或血肿主要情况"),
		@Column(name="vsd_5_1_3", attrName="vsd_5_1_3", label="是否再手术"),
		@Column(name="vsd_5_1_4", attrName="vsd_5_1_4", label="再手术起始日期时间"),
		...
		@Column(name="cm_2_3_15", attrName="cm_2_3_15", label="术后并发脑卒中/脑血管事件"),
		@Column(name="cm_2_3", attrName="cm_2_3", label="心脏手术后特指并发症类别及ICD-10四位亚目的选择"),
		@Column(name="cm_2_4", attrName="cm_2_4", label="影响程度的选择"),
		@Column(name="vsd_7_1_1_1", attrName="vsd_7_1_1_1", label="是否进行术前健康教育，且有记录"),
		@Column(name="vsd_7_1_1", attrName="vsd_7_1_1", label="手术前健康教育项目的选择"),
		@Column(name="vsd_7_2_1", attrName="vsd_7_2_1", label="出院时,告知患者高危因素本人评估结果"),
		@Column(name="vsd_7_2_2", attrName="vsd_7_2_2", label="常见高危因素的选择"),
		@Column(name="vsd_7_2_2_1", attrName="vsd_7_2_2_1", label="其他常见高危因素"),
		@Column(name="vsd_7_3_1_1", attrName="vsd_7_3_1_1", label="是否履行出院教育与告知责任，且有记录"),
		@Column(name="vsd_7_3_1", attrName="vsd_7_3_1", label="交与患者/患儿家长“出院小结”的副本告知患者/患儿家长出院时风险因素"),
		@Column(name="vsd_7_3_2", attrName="vsd_7_3_2", label="出院带药", comment="出院带药: 坚持抗凝治疗"),
		@Column(name="vsd_7_3_3", attrName="vsd_7_3_3", label="告知发生紧急情况时求援救治途径"),
		@Column(name="vsd_7_3_4", attrName="vsd_7_3_4", label="出院时教育与随访"),
		@Column(name="vsd_7_3_5", attrName="vsd_7_3_5", label="告知何为风险因素与紧急情况"),
...
public class QualityVsd extends DataEntity<QualityVsd> {
	...
	private Double vsd_1_1_2;		// 左室射血分数（LVEF）测量值
	private String vsd_1_1_3;		// 室间隔缺损手术缺损分型
	private String vsd_1_1_4;		// VSD是否多发
	private String vsd_1_2_1;		// 是否实施手术前的心导管检查评估
	private Double vsd_1_2_2_1;		// 肺循环血量
	private Double vsd_1_2_2_2;		// 体循环血量
	private Double vsd_1_2_2;		// 肺循环血量/体循环血量比值(QP/QS)
	...
	private Double vsd_3_3_2;		// 其中:全血量(ml)
	private Double vsd_3_3_3;		// 其中:红细胞量(ml)
	private Double vsd_3_3_4;		// 其中:血浆量(ml)
	private Double vsd_3_3_5;		// 其中:血小板量(ml)
	private Double vsd_3_3_6;		// 临床用血总量(ml)
	...
	public String getVsd_1_1_1() {
		return vsd_1_1_1;
	}

	public void setVsd_1_1_1(String vsd_1_1_1) {
		this.vsd_1_1_1 = vsd_1_1_1;
	}
	
	public Double getVsd_1_1_2() {
		return vsd_1_1_2;
	}

	public void setVsd_1_1_2(Double vsd_1_1_2) {
		this.vsd_1_1_2 = vsd_1_1_2;
	}
	
	@Length(min=0, max=64, message="室间隔缺损手术缺损分型长度不能超过 64 个字符")
	public String getVsd_1_1_3() {
		return vsd_1_1_3;
	}

	public void setVsd_1_1_3(String vsd_1_1_3) {
		this.vsd_1_1_3 = vsd_1_1_3;
	}
	
	@Length(min=0, max=64, message="VSD是否多发长度不能超过 64 个字符")
	public String getVsd_1_1_4() {
		return vsd_1_1_4;
	}

	public void setVsd_1_1_4(String vsd_1_1_4) {
		this.vsd_1_1_4 = vsd_1_1_4;
	}
	
	@Length(min=0, max=64, message="是否实施手术前的心导管检查评估长度不能超过 64 个字符")
	public String getVsd_1_2_1() {
		return vsd_1_2_1;
	}

	public void setVsd_1_2_1(String vsd_1_2_1) {
		this.vsd_1_2_1 = vsd_1_2_1;
	}
	
	public Double getVsd_1_2_2_1() {
		return vsd_1_2_2_1;
	}

	public void setVsd_1_2_2_1(Double vsd_1_2_2_1) {
		this.vsd_1_2_2_1 = vsd_1_2_2_1;
	}
	
	public Double getVsd_1_2_2_2() {
		return vsd_1_2_2_2;
	}

	public void setVsd_1_2_2_2(Double vsd_1_2_2_2) {
		this.vsd_1_2_2_2 = vsd_1_2_2_2;
	}
	
	public Double getVsd_1_2_2() {
		return vsd_1_2_2;
	}

	public void setVsd_1_2_2(Double vsd_1_2_2) {
		this.vsd_1_2_2 = vsd_1_2_2;
	}
	
	@Length(min=0, max=64, message="室间隔缺损手术缺损手术适应证长度不能超过 64 个字符")
	public String getVsd_2_1_1() {
		return vsd_2_1_1;
	}

	public void setVsd_2_1_1(String vsd_2_1_1) {
		this.vsd_2_1_1 = vsd_2_1_1;
	}
	
	@Length(min=0, max=64, message="其他室间隔缺损手术适应证长度不能超过 64 个字符")
	public String getVsd_2_1_1_1() {
		return vsd_2_1_1_1;
	}

	public void setVsd_2_1_1_1(String vsd_2_1_1_1) {
		this.vsd_2_1_1_1 = vsd_2_1_1_1;
	}
	
	@Length(min=0, max=64, message="手术方法的选择长度不能超过 64 个字符")
	public String getVsd_2_1_2() {
		return vsd_2_1_2;
	}

	public void setVsd_2_1_2(String vsd_2_1_2) {
		this.vsd_2_1_2 = vsd_2_1_2;
	}
	
	@Length(min=0, max=64, message="其他手术方法长度不能超过 64 个字符")
	public String getVsd_2_1_2_1() {
		return vsd_2_1_2_1;
	}

	public void setVsd_2_1_2_1(String vsd_2_1_2_1) {
		this.vsd_2_1_2_1 = vsd_2_1_2_1;
	}
	
	@Length(min=0, max=64, message="是否使用体外循环长度不能超过 64 个字符")
	public String getVsd_3_1_1() {
		return vsd_3_1_1;
	}

	public void setVsd_3_1_1(String vsd_3_1_1) {
		this.vsd_3_1_1 = vsd_3_1_1;
	}
	
	@Length(min=0, max=64, message="起始日期时间长度不能超过 64 个字符")
	public String getVsd_3_1_2() {
		return vsd_3_1_2;
	}

	public void setVsd_3_1_2(String vsd_3_1_2) {
		this.vsd_3_1_2 = vsd_3_1_2;
	}
	
	@Length(min=0, max=64, message="终止日期时间长度不能超过 64 个字符")
	public String getVsd_3_1_3() {
		return vsd_3_1_3;
	}

	public void setVsd_3_1_3(String vsd_3_1_3) {
		this.vsd_3_1_3 = vsd_3_1_3;
	}
	
	@Length(min=0, max=64, message="术中是否再次阻断主动脉长度不能超过 64 个字符")
	public String getVsd_3_2_1_1() {
		return vsd_3_2_1_1;
	}

	public void setVsd_3_2_1_1(String vsd_3_2_1_1) {
		this.vsd_3_2_1_1 = vsd_3_2_1_1;
	}
	
	@Length(min=0, max=64, message="术中使用经食道超声长度不能超过 64 个字符")
	public String getVsd_3_2_1() {
		return vsd_3_2_1;
	}

	public void setVsd_3_2_1(String vsd_3_2_1) {
		this.vsd_3_2_1 = vsd_3_2_1;
	}
	
	@Length(min=0, max=64, message="是否存在残余分流长度不能超过 64 个字符")
	public String getVsd_3_2_1_2() {
		return vsd_3_2_1_2;
	}

	public void setVsd_3_2_1_2(String vsd_3_2_1_2) {
		this.vsd_3_2_1_2 = vsd_3_2_1_2;
	}
	
	@Length(min=0, max=64, message="是否围术期使用血制品长度不能超过 64 个字符")
	public String getVsd_3_3_1() {
		return vsd_3_3_1;
	}

	public void setVsd_3_3_1(String vsd_3_3_1) {
		this.vsd_3_3_1 = vsd_3_3_1;
	}
	
	public Double getVsd_3_3_2() {
		return vsd_3_3_2;
	}

	public void setVsd_3_3_2(Double vsd_3_3_2) {
		this.vsd_3_3_2 = vsd_3_3_2;
	}
	
	public Double getVsd_3_3_3() {
		return vsd_3_3_3;
	}

	public void setVsd_3_3_3(Double vsd_3_3_3) {
		this.vsd_3_3_3 = vsd_3_3_3;
	}
	
	public Double getVsd_3_3_4() {
		return vsd_3_3_4;
	}

	public void setVsd_3_3_4(Double vsd_3_3_4) {
		this.vsd_3_3_4 = vsd_3_3_4;
	}
	
	public Double getVsd_3_3_5() {
		return vsd_3_3_5;
	}

	public void setVsd_3_3_5(Double vsd_3_3_5) {
		this.vsd_3_3_5 = vsd_3_3_5;
	}
	
	public Double getVsd_3_3_6() {
		return vsd_3_3_6;
	}

	public void setVsd_3_3_6(Double vsd_3_3_6) {
		this.vsd_3_3_6 = vsd_3_3_6;
	}
	
	@Length(min=0, max=64, message="是否实施术后机械通气长度不能超过 64 个字符")
	public String getVsd_3_4_1() {
		return vsd_3_4_1;
	}

	public void setVsd_3_4_1(String vsd_3_4_1) {
		this.vsd_3_4_1 = vsd_3_4_1;
	}
	
	@Length(min=0, max=64, message="起始日期时间长度不能超过 64 个字符")
	public String getVsd_3_4_2() {
		return vsd_3_4_2;
	}

	public void setVsd_3_4_2(String vsd_3_4_2) {
		this.vsd_3_4_2 = vsd_3_4_2;
	}
	
	@Length(min=0, max=64, message="终止日期时间长度不能超过 64 个字符")
	public String getVsd_3_4_3() {
		return vsd_3_4_3;
	}

	public void setVsd_3_4_3(String vsd_3_4_3) {
		this.vsd_3_4_3 = vsd_3_4_3;
	}
	...
	public String getVsd_5_1_1() {
		return vsd_5_1_1;
	}

	public void setVsd_5_1_1(String vsd_5_1_1) {
		this.vsd_5_1_1 = vsd_5_1_1;
	}
	
	@Length(min=0, max=64, message="术后活动性出血或血肿主要情况长度不能超过 64 个字符")
	public String getVsd_5_1_2() {
		return vsd_5_1_2;
	}

	public void setVsd_5_1_2(String vsd_5_1_2) {
		this.vsd_5_1_2 = vsd_5_1_2;
	}
	
	@Length(min=0, max=64, message="是否再手术长度不能超过 64 个字符")
	public String getVsd_5_1_3() {
		return vsd_5_1_3;
	}

	public void setVsd_5_1_3(String vsd_5_1_3) {
		this.vsd_5_1_3 = vsd_5_1_3;
	}
	
	@Length(min=0, max=64, message="再手术起始日期时间长度不能超过 64 个字符")
	public String getVsd_5_1_4() {
		return vsd_5_1_4;
	}

	public void setVsd_5_1_4(String vsd_5_1_4) {
		this.vsd_5_1_4 = vsd_5_1_4;
	}
	...
	public String getVsd_7_1_1_1() {
		return vsd_7_1_1_1;
	}

	public void setVsd_7_1_1_1(String vsd_7_1_1_1) {
		this.vsd_7_1_1_1 = vsd_7_1_1_1;
	}
	
	@Length(min=0, max=64, message="手术前健康教育项目的选择长度不能超过 64 个字符")
	public String getVsd_7_1_1() {
		return vsd_7_1_1;
	}

	public void setVsd_7_1_1(String vsd_7_1_1) {
		this.vsd_7_1_1 = vsd_7_1_1;
	}
	
	@Length(min=0, max=64, message="出院时,告知患者高危因素本人评估结果长度不能超过 64 个字符")
	public String getVsd_7_2_1() {
		return vsd_7_2_1;
	}

	public void setVsd_7_2_1(String vsd_7_2_1) {
		this.vsd_7_2_1 = vsd_7_2_1;
	}
	
	@Length(min=0, max=64, message="常见高危因素的选择长度不能超过 64 个字符")
	public String getVsd_7_2_2() {
		return vsd_7_2_2;
	}

	public void setVsd_7_2_2(String vsd_7_2_2) {
		this.vsd_7_2_2 = vsd_7_2_2;
	}
	
	@Length(min=0, max=64, message="其他常见高危因素长度不能超过 64 个字符")
	public String getVsd_7_2_2_1() {
		return vsd_7_2_2_1;
	}

	public void setVsd_7_2_2_1(String vsd_7_2_2_1) {
		this.vsd_7_2_2_1 = vsd_7_2_2_1;
	}
	
	@Length(min=0, max=64, message="是否履行出院教育与告知责任，且有记录长度不能超过 64 个字符")
	public String getVsd_7_3_1_1() {
		return vsd_7_3_1_1;
	}

	public void setVsd_7_3_1_1(String vsd_7_3_1_1) {
		this.vsd_7_3_1_1 = vsd_7_3_1_1;
	}
	
	@Length(min=0, max=64, message="交与患者/患儿家长“出院小结”的副本告知患者/患儿家长出院时风险因素长度不能超过 64 个字符")
	public String getVsd_7_3_1() {
		return vsd_7_3_1;
	}

	public void setVsd_7_3_1(String vsd_7_3_1) {
		this.vsd_7_3_1 = vsd_7_3_1;
	}
	
	@Length(min=0, max=64, message="出院带药长度不能超过 64 个字符")
	public String getVsd_7_3_2() {
		return vsd_7_3_2;
	}

	public void setVsd_7_3_2(String vsd_7_3_2) {
		this.vsd_7_3_2 = vsd_7_3_2;
	}
	
	@Length(min=0, max=64, message="告知发生紧急情况时求援救治途径长度不能超过 64 个字符")
	public String getVsd_7_3_3() {
		return vsd_7_3_3;
	}

	public void setVsd_7_3_3(String vsd_7_3_3) {
		this.vsd_7_3_3 = vsd_7_3_3;
	}
	
	@Length(min=0, max=64, message="出院时教育与随访长度不能超过 64 个字符")
	public String getVsd_7_3_4() {
		return vsd_7_3_4;
	}

	public void setVsd_7_3_4(String vsd_7_3_4) {
		this.vsd_7_3_4 = vsd_7_3_4;
	}
	
	@Length(min=0, max=64, message="告知何为风险因素与紧急情况长度不能超过 64 个字符")
	public String getVsd_7_3_5() {
		return vsd_7_3_5;
	}

	public void setVsd_7_3_5(String vsd_7_3_5) {
		this.vsd_7_3_5 = vsd_7_3_5;
	}
