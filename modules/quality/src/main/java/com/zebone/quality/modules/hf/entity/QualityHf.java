...
public class QualityHf extends DataEntity<QualityHf> {
	...
	private Date hf_1_5_1_2;		// 首次检测结果报告日期
	...
	public void setCm_0_1_1_1(String cm0111) {
		System.out.println("++++++++++++++++++++++++++"+cm0111);
		this.cm_0_1_1_1 = cm0111;
	}
	...
	@NotBlank(message="是否实施首次超声心动图不能为空")
	...
	@NotBlank(message="急诊或入院后是否首次心电图不能为空")
	...
	@NotBlank(message="是否有用药长期医嘱不能为空")
	...
	@NotBlank(message="是否实施末次超声心动图不能为空")
