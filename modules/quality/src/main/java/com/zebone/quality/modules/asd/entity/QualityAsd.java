...
public class QualityAsd extends DataEntity<QualityAsd> {
	...
	public String getAsd_3_1_1() {
		return asd_3_1_1;
	}

	public void setAsd_3_1_1(String asd_3_1_1) {
		this.asd_3_1_1 = asd_3_1_1;
	}
	
	@Length(min=0, max=64, message="终止日期时间长度不能超过 64 个字符")
	public String getAsd_3_1_2() {
		return asd_3_1_2;
	}

	public void setAsd_3_1_2(String asd_3_1_2) {
	...
	@Length(min=0, max=64, message="起始日期时间长度不能超过 64 个字符")
	public String getAsd_3_4_2() {
		return asd_3_4_2;
	}

	public void setAsd_3_4_2(String asd_3_4_2) {
		this.asd_3_4_2 = asd_3_4_2;
	}
	
	@Length(min=0, max=64, message="终止日期时间长度不能超过 64 个字符")
	public String getAsd_3_4_3() {
		return asd_3_4_3;
	}

	public void setAsd_3_4_3(String asd_3_4_3) {
