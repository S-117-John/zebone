...
public class Lc implements Serializable {
    ...
    @JSONField(name="LC-1-1-1")
    private String lc_1_1_1;
    @JSONField(name="LC-1-1-2")
    private String lc_1_1_2;
    @JSONField(name="LC-1-1-3")
    private String lc_1_1_3;
    @JSONField(name="LC-1-1-4")
    private String lc_1_1_4;
    @JSONField(name="LC-1-1-5")
    private String lc_1_1_5;
    @JSONField(name="LC-1-2-1")
    private String lc_1_2_1;
    @JSONField(name="LC-2-1-1")
    private String lc_2_1_1;
    @JSONField(name="LC-2-1-2")
    private String lc_2_1_2;
    @JSONField(name="LC-2-1-2-1")
    private String lc_2_1_2_1;
    @JSONField(name="LC-2-1-3")
    private String lc_2_1_3;
    @JSONField(name="LC-3-1-1")
    private String lc_3_1_1;
    @JSONField(name="LC-4-1-1")
    private String lc_4_1_1;
    @JSONField(name="LC-4-1-1-1")
    private String lc_4_1_1_1;
    @JSONField(name="LC-4-2-1")
    private String lc_4_2_1;
    @JSONField(name="LC-4-2-2")
    private String lc_4_2_2;
    @JSONField(name="LC-4-2-2-1")
    private String lc_4_2_2_1;
    @JSONField(name="LC-4-3-1")
    private String lc_4_3_1;
    @JSONField(name="LC-4-3-2-1")
    private String lc_4_3_2_1;
    @JSONField(name="LC-4-3-3-1")
