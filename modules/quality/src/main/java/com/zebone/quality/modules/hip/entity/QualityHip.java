 ...
 */
package com.zebone.quality.modules.hip.entity;
 ...
 * @version 2021-01-21
 */
@Table(name="quality_hip", alias="a", columns={
		...
		@Column(name="hip_0_1_4_1", attrName="hip_0_1_4_1", label="其他手术操作栏中提取ICD-9-CM-3六位临床扩展编码与名称"),
		...
		@Column(name="hip_0_1_3_1", attrName="hip_0_1_3_1", label="其他主要诊断ICD-10六位临床扩展编码与名称"),
		...
		@Column(name="hip_1_1_1", attrName="hip_1_1_1", label="人工髋关节置换术适应证"),
		@Column(name="hip_1_1_1_1", attrName="hip_1_1_1_1", label="其他骨关节疾患填写"),
		@Column(name="hip_1_1_2", attrName="hip_1_1_2", label="病变侧别"),
		@Column(name="hip_1_2_1", attrName="hip_1_2_1", label="是否实施髋关节功能评估"),
		@Column(name="hip_1_2_2_2", attrName="hip_1_2_2_2", label="左Harris评分值"),
		@Column(name="hip_1_2_2_4", attrName="hip_1_2_2_4", label="左侧评估结果的分层"),
		@Column(name="hip_1_2_2_1", attrName="hip_1_2_2_1", label="右Harris评分值"),
		@Column(name="hip_1_2_2_3", attrName="hip_1_2_2_3", label="右侧评估结果的分层"),
		@Column(name="hip_1_3_1", attrName="hip_1_3_1", label="麻醉方式"),
		@Column(name="hip_1_4_1", attrName="hip_1_4_1", label="决定手术方案的医师资质"),
		@Column(name="hip_1_4_1_1", attrName="hip_1_4_1_1", label="其他决定手术方案的医师资质"),
		...
		@Column(name="hip_3_1_1", attrName="hip_3_1_1", label="有无实施手术患者静脉血栓栓塞症风险评估"),
		@Column(name="hip_3_1_2", attrName="hip_3_1_2", label="Caprini评估分值"),
		@Column(name="hip_3_1_3", attrName="hip_3_1_3", label="Caprini评估风险分层"),
		@Column(name="hip_3_1_8", attrName="hip_3_1_8", label="临床常用检测方法"),
		@Column(name="hip_3_2_1", attrName="hip_3_2_1", label="有无实施预防术后深静脉血栓措施的禁忌"),
		@Column(name="hip_3_2_2_1", attrName="hip_3_2_2_1", label="实施药物预防措施绝对禁忌证"),
		@Column(name="hip_3_2_2_2", attrName="hip_3_2_2_2", label="实施药物预防措施相对禁忌证"),
		@Column(name="hip_3_2_3", attrName="hip_3_2_3", label="实施机械预防措施应用禁忌"),
		@Column(name="hip_3_2_4", attrName="hip_3_2_4", label="预防深静脉栓塞医嘱执行起始日期"),
		@Column(name="hip_3_3_1_1", attrName="hip_3_3_1_1", label="基本预防措施"),
		@Column(name="hip_3_3_2", attrName="hip_3_3_2", label="基本预防措施日期时间"),
		@Column(name="hip_3_3_3", attrName="hip_3_3_3", label="机械预防措施"),
		@Column(name="hip_3_3_4", attrName="hip_3_3_4", label="机械预防措施日期时间"),
		@Column(name="hip_3_3_5", attrName="hip_3_3_5", label="预防性地给予药物的选择"),
		@Column(name="hip_3_3_5_1", attrName="hip_3_3_5_1", label="其它预防性地给予药物"),
		@Column(name="hip_3_3_6", attrName="hip_3_3_6", label="预防性地给予药物日期时间"),
		@Column(name="hip_3_4_1", attrName="hip_3_4_1", label="出院后继续使用抗凝药"),
		@Column(name="hip_3_4_1_1", attrName="hip_3_4_1_1", label="出院后继续使用其它抗凝药"),
		@Column(name="hip_4_1_1", attrName="hip_4_1_1", label="是否实施输血"),
		@Column(name="hip_4_2_1", attrName="hip_4_2_1", label="临床用血类别"),
		@Column(name="hip_4_2_1_1", attrName="hip_4_2_1_1", label="输血部位"),
		@Column(name="hip_2_7", attrName="hip_2_7", label="术后72小时之后继续使用的原因?"),
		@Column(name="hip_4_2_2_1", attrName="hip_4_2_2_1", label="单侧手术术中输血量", comment="单侧手术术中输血量（ml）"),
		@Column(name="hip_4_2_2_2", attrName="hip_4_2_2_2", label="单侧手术术后输血量", comment="单侧手术术后输血量（ml）"),
		@Column(name="hip_4_2_3_1", attrName="hip_4_2_3_1", label="双侧手术术中输血量", comment="双侧手术术中输血量（ml）"),
		@Column(name="hip_4_2_3_2", attrName="hip_4_2_3_2", label="双侧手术术后输血量", comment="双侧手术术后输血量（ml）"),
		@Column(name="hip_5_1_1", attrName="hip_5_1_1", label="是否康复治疗前评估"),
		@Column(name="hip_5_1_2", attrName="hip_5_1_2", label="康复治疗适宜性评估结果"),
		@Column(name="hip_5_1_3", attrName="hip_5_1_3", label="康复实施人员实施康复的方式"),
		@Column(name="hip_5_1_4", attrName="hip_5_1_4", label="康复实施日期", comment="康复实施日期(首次)"),
		@Column(name="hip_5_1_5", attrName="hip_5_1_5", label="选择未能进行康复原因"),
		@Column(name="hip_5_2_1_1", attrName="hip_5_2_1_1", label="是否进行手术后镇痛治疗"),
		@Column(name="hip_5_2_2_2", attrName="hip_5_2_2_2", label="疼痛强度评估方法的选择"),
		@Column(name="hip_5_2_2_1", attrName="hip_5_2_2_1", label="其他疼痛强度评估方法"),
		@Column(name="hip_5_2_3", attrName="hip_5_2_3", label="药物选择多模式"),
		@Column(name="hip_5_2_3_1", attrName="hip_5_2_3_1", label="药物选择多模式填写"),
		@Column(name="hip_5_2_4", attrName="hip_5_2_4", label="镇痛用药多途径"),
		@Column(name="hip_5_2_4_1", attrName="hip_5_2_4_1", label="其他镇痛方法"),
		...
		@Column(name="hip_6_1_2_1", attrName="hip_6_1_2_1", label="住院患者发生压疮"),
		@Column(name="hip_6_1_2_2", attrName="hip_6_1_2_2", label="肌肉骨骼系统术后并发症"),
		@Column(name="hip_6_1_2_3", attrName="hip_6_1_2_3", label="骨科植入物的并发症", comment="骨科植入物的并发症(不包括脓毒症)"),
		@Column(name="hip_6_2_1_1", attrName="hip_6_2_1_1", label="是否伴有内科原有疾病治疗"),
		@Column(name="hip_6_2_2", attrName="hip_6_2_2", label="伴有主要的内科疾患"),
		@Column(name="hip_6_2_2_1", attrName="hip_6_2_2_1", label="其他系统疾病"),
		@Column(name="cm_2_4", attrName="cm_2_4", label="影响程度的选择"),
		@Column(name="hip_7_1_1", attrName="hip_7_1_1", label="入院宣教"),
		@Column(name="hip_7_1_2", attrName="hip_7_1_2", label="术前一日的健康教育"),
		@Column(name="hip_7_1_3", attrName="hip_7_1_3", label="术后六小时内的健康教育"),
		@Column(name="hip_7_1_4", attrName="hip_7_1_4", label="术后六小时至二十四小时的健康教育"),
		@Column(name="hip_7_1_5", attrName="hip_7_1_5", label="术后一周内健康教育"),
		@Column(name="hip_7_1_6", attrName="hip_7_1_6", label="术后一周后健康教育"),
		@Column(name="hip_7_1_7", attrName="hip_7_1_7", label="为患者提供出院前健康教育"),
...
public class QualityHip extends DataEntity<QualityHip> {
	...
	private Double hip_1_2_2_2;		// 左Harris评分值
	private String hip_1_2_2_4;		// 左侧评估结果的分层
	private Double hip_1_2_2_1;		// 右Harris评分值
	...
	private Double hip_3_1_2;		// Caprini评估分值
	...
	private String hip_2_7;		// 术后72小时之后继续使用的原因?
	private Double hip_4_2_2_1;		// 单侧手术术中输血量（ml）
	private Double hip_4_2_2_2;		// 单侧手术术后输血量（ml）
	private Double hip_4_2_3_1;		// 双侧手术术中输血量（ml）
	private Double hip_4_2_3_2;		// 双侧手术术后输血量（ml）
	...
	@Length(min=0, max=64, message="其他手术操作栏中提取ICD-9-CM-3六位临床扩展编码与名称长度不能超过 64 个字符")
	public String getHip_0_1_4_1() {
		return hip_0_1_4_1;
	}

	public void setHip_0_1_4_1(String hip_0_1_4_1) {
		this.hip_0_1_4_1 = hip_0_1_4_1;
	}
	...
	public String getHip_0_1_3_1() {
		return hip_0_1_3_1;
	}

	public void setHip_0_1_3_1(String hip_0_1_3_1) {
		this.hip_0_1_3_1 = hip_0_1_3_1;
	}
	...
	@Length(min=0, max=64, message="人工髋关节置换术适应证长度不能超过 64 个字符")
	public String getHip_1_1_1() {
		return hip_1_1_1;
	}

	public void setHip_1_1_1(String hip_1_1_1) {
		this.hip_1_1_1 = hip_1_1_1;
	}
	
	@Length(min=0, max=64, message="其他骨关节疾患填写长度不能超过 64 个字符")
	public String getHip_1_1_1_1() {
		return hip_1_1_1_1;
	}

	public void setHip_1_1_1_1(String hip_1_1_1_1) {
		this.hip_1_1_1_1 = hip_1_1_1_1;
	}
	
	@Length(min=0, max=64, message="病变侧别长度不能超过 64 个字符")
	public String getHip_1_1_2() {
		return hip_1_1_2;
	}

	public void setHip_1_1_2(String hip_1_1_2) {
		this.hip_1_1_2 = hip_1_1_2;
	}
	
	@Length(min=0, max=64, message="是否实施髋关节功能评估长度不能超过 64 个字符")
	public String getHip_1_2_1() {
		return hip_1_2_1;
	}

	public void setHip_1_2_1(String hip_1_2_1) {
		this.hip_1_2_1 = hip_1_2_1;
	}
	
	public Double getHip_1_2_2_2() {
		return hip_1_2_2_2;
	}

	public void setHip_1_2_2_2(Double hip_1_2_2_2) {
		this.hip_1_2_2_2 = hip_1_2_2_2;
	}
	
	@Length(min=0, max=64, message="左侧评估结果的分层长度不能超过 64 个字符")
	public String getHip_1_2_2_4() {
		return hip_1_2_2_4;
	}

	public void setHip_1_2_2_4(String hip_1_2_2_4) {
		this.hip_1_2_2_4 = hip_1_2_2_4;
	}
	
	public Double getHip_1_2_2_1() {
		return hip_1_2_2_1;
	}

	public void setHip_1_2_2_1(Double hip_1_2_2_1) {
		this.hip_1_2_2_1 = hip_1_2_2_1;
	}
	
	@Length(min=0, max=64, message="右侧评估结果的分层长度不能超过 64 个字符")
	public String getHip_1_2_2_3() {
		return hip_1_2_2_3;
	}

	public void setHip_1_2_2_3(String hip_1_2_2_3) {
		this.hip_1_2_2_3 = hip_1_2_2_3;
	}
	
	@Length(min=0, max=64, message="麻醉方式长度不能超过 64 个字符")
	public String getHip_1_3_1() {
		return hip_1_3_1;
	}

	public void setHip_1_3_1(String hip_1_3_1) {
		this.hip_1_3_1 = hip_1_3_1;
	}
	
	@Length(min=0, max=64, message="决定手术方案的医师资质长度不能超过 64 个字符")
	public String getHip_1_4_1() {
		return hip_1_4_1;
	}

	public void setHip_1_4_1(String hip_1_4_1) {
		this.hip_1_4_1 = hip_1_4_1;
	}
	
	@Length(min=0, max=64, message="其他决定手术方案的医师资质长度不能超过 64 个字符")
	public String getHip_1_4_1_1() {
		return hip_1_4_1_1;
	}

	public void setHip_1_4_1_1(String hip_1_4_1_1) {
		this.hip_1_4_1_1 = hip_1_4_1_1;
	}
	...
	public String getHip_3_1_1() {
		return hip_3_1_1;
	}

	public void setHip_3_1_1(String hip_3_1_1) {
		this.hip_3_1_1 = hip_3_1_1;
	}
	
	public Double getHip_3_1_2() {
		return hip_3_1_2;
	}

	public void setHip_3_1_2(Double hip_3_1_2) {
		this.hip_3_1_2 = hip_3_1_2;
	}
	
	@Length(min=0, max=64, message="Caprini评估风险分层长度不能超过 64 个字符")
	public String getHip_3_1_3() {
		return hip_3_1_3;
	}

	public void setHip_3_1_3(String hip_3_1_3) {
		this.hip_3_1_3 = hip_3_1_3;
	}
	
	@Length(min=0, max=64, message="临床常用检测方法长度不能超过 64 个字符")
	public String getHip_3_1_8() {
		return hip_3_1_8;
	}

	public void setHip_3_1_8(String hip_3_1_8) {
		this.hip_3_1_8 = hip_3_1_8;
	}
	
	@Length(min=0, max=64, message="有无实施预防术后深静脉血栓措施的禁忌长度不能超过 64 个字符")
	public String getHip_3_2_1() {
		return hip_3_2_1;
	}

	public void setHip_3_2_1(String hip_3_2_1) {
		this.hip_3_2_1 = hip_3_2_1;
	}
	
	@Length(min=0, max=64, message="实施药物预防措施绝对禁忌证长度不能超过 64 个字符")
	public String getHip_3_2_2_1() {
		return hip_3_2_2_1;
	}

	public void setHip_3_2_2_1(String hip_3_2_2_1) {
		this.hip_3_2_2_1 = hip_3_2_2_1;
	}
	
	@Length(min=0, max=64, message="实施药物预防措施相对禁忌证长度不能超过 64 个字符")
	public String getHip_3_2_2_2() {
		return hip_3_2_2_2;
	}

	public void setHip_3_2_2_2(String hip_3_2_2_2) {
		this.hip_3_2_2_2 = hip_3_2_2_2;
	}
	
	@Length(min=0, max=64, message="实施机械预防措施应用禁忌长度不能超过 64 个字符")
	public String getHip_3_2_3() {
		return hip_3_2_3;
	}

	public void setHip_3_2_3(String hip_3_2_3) {
		this.hip_3_2_3 = hip_3_2_3;
	}
	
	@Length(min=0, max=64, message="预防深静脉栓塞医嘱执行起始日期长度不能超过 64 个字符")
	public String getHip_3_2_4() {
		return hip_3_2_4;
	}

	public void setHip_3_2_4(String hip_3_2_4) {
		this.hip_3_2_4 = hip_3_2_4;
	}
	
	@Length(min=0, max=64, message="基本预防措施长度不能超过 64 个字符")
	public String getHip_3_3_1_1() {
		return hip_3_3_1_1;
	}

	public void setHip_3_3_1_1(String hip_3_3_1_1) {
		this.hip_3_3_1_1 = hip_3_3_1_1;
	}
	
	@Length(min=0, max=64, message="基本预防措施日期时间长度不能超过 64 个字符")
	public String getHip_3_3_2() {
		return hip_3_3_2;
	}

	public void setHip_3_3_2(String hip_3_3_2) {
		this.hip_3_3_2 = hip_3_3_2;
	}
	
	@Length(min=0, max=64, message="机械预防措施长度不能超过 64 个字符")
	public String getHip_3_3_3() {
		return hip_3_3_3;
	}

	public void setHip_3_3_3(String hip_3_3_3) {
		this.hip_3_3_3 = hip_3_3_3;
	}
	
	@Length(min=0, max=64, message="机械预防措施日期时间长度不能超过 64 个字符")
	public String getHip_3_3_4() {
		return hip_3_3_4;
	}

	public void setHip_3_3_4(String hip_3_3_4) {
		this.hip_3_3_4 = hip_3_3_4;
	}
	
	@Length(min=0, max=64, message="预防性地给予药物的选择长度不能超过 64 个字符")
	public String getHip_3_3_5() {
		return hip_3_3_5;
	}

	public void setHip_3_3_5(String hip_3_3_5) {
		this.hip_3_3_5 = hip_3_3_5;
	}
	
	@Length(min=0, max=64, message="其它预防性地给予药物长度不能超过 64 个字符")
	public String getHip_3_3_5_1() {
		return hip_3_3_5_1;
	}

	public void setHip_3_3_5_1(String hip_3_3_5_1) {
		this.hip_3_3_5_1 = hip_3_3_5_1;
	}
	
	@Length(min=0, max=64, message="预防性地给予药物日期时间长度不能超过 64 个字符")
	public String getHip_3_3_6() {
		return hip_3_3_6;
	}

	public void setHip_3_3_6(String hip_3_3_6) {
		this.hip_3_3_6 = hip_3_3_6;
	}
	
	@Length(min=0, max=64, message="出院后继续使用抗凝药长度不能超过 64 个字符")
	public String getHip_3_4_1() {
		return hip_3_4_1;
	}

	public void setHip_3_4_1(String hip_3_4_1) {
		this.hip_3_4_1 = hip_3_4_1;
	}
	
	@Length(min=0, max=64, message="出院后继续使用其它抗凝药长度不能超过 64 个字符")
	public String getHip_3_4_1_1() {
		return hip_3_4_1_1;
	}

	public void setHip_3_4_1_1(String hip_3_4_1_1) {
		this.hip_3_4_1_1 = hip_3_4_1_1;
	}
	
	@Length(min=0, max=64, message="是否实施输血长度不能超过 64 个字符")
	public String getHip_4_1_1() {
		return hip_4_1_1;
	}

	public void setHip_4_1_1(String hip_4_1_1) {
		this.hip_4_1_1 = hip_4_1_1;
	}
	
	@Length(min=0, max=64, message="临床用血类别长度不能超过 64 个字符")
	public String getHip_4_2_1() {
		return hip_4_2_1;
	}

	public void setHip_4_2_1(String hip_4_2_1) {
		this.hip_4_2_1 = hip_4_2_1;
	}
	
	@Length(min=0, max=64, message="输血部位长度不能超过 64 个字符")
	public String getHip_4_2_1_1() {
		return hip_4_2_1_1;
	}

	public void setHip_4_2_1_1(String hip_4_2_1_1) {
		this.hip_4_2_1_1 = hip_4_2_1_1;
	}
	
	@Length(min=0, max=64, message="术后72小时之后继续使用的原因?长度不能超过 64 个字符")
	public String getHip_2_7() {
		return hip_2_7;
	}

	public void setHip_2_7(String hip_2_7) {
		this.hip_2_7 = hip_2_7;
	}
	
	public Double getHip_4_2_2_1() {
		return hip_4_2_2_1;
	}

	public void setHip_4_2_2_1(Double hip_4_2_2_1) {
		this.hip_4_2_2_1 = hip_4_2_2_1;
	}
	
	public Double getHip_4_2_2_2() {
		return hip_4_2_2_2;
	}

	public void setHip_4_2_2_2(Double hip_4_2_2_2) {
		this.hip_4_2_2_2 = hip_4_2_2_2;
	}
	
	public Double getHip_4_2_3_1() {
		return hip_4_2_3_1;
	}

	public void setHip_4_2_3_1(Double hip_4_2_3_1) {
		this.hip_4_2_3_1 = hip_4_2_3_1;
	}
	
	public Double getHip_4_2_3_2() {
		return hip_4_2_3_2;
	}

	public void setHip_4_2_3_2(Double hip_4_2_3_2) {
		this.hip_4_2_3_2 = hip_4_2_3_2;
	}
	
	@Length(min=0, max=64, message="是否康复治疗前评估长度不能超过 64 个字符")
	public String getHip_5_1_1() {
		return hip_5_1_1;
	}

	public void setHip_5_1_1(String hip_5_1_1) {
		this.hip_5_1_1 = hip_5_1_1;
	}
	
	@Length(min=0, max=64, message="康复治疗适宜性评估结果长度不能超过 64 个字符")
	public String getHip_5_1_2() {
		return hip_5_1_2;
	}

	public void setHip_5_1_2(String hip_5_1_2) {
		this.hip_5_1_2 = hip_5_1_2;
	}
	
	@Length(min=0, max=64, message="康复实施人员实施康复的方式长度不能超过 64 个字符")
	public String getHip_5_1_3() {
		return hip_5_1_3;
	}

	public void setHip_5_1_3(String hip_5_1_3) {
		this.hip_5_1_3 = hip_5_1_3;
	}
	
	@Length(min=0, max=64, message="康复实施日期长度不能超过 64 个字符")
	public String getHip_5_1_4() {
		return hip_5_1_4;
	}

	public void setHip_5_1_4(String hip_5_1_4) {
		this.hip_5_1_4 = hip_5_1_4;
	}
	
	@Length(min=0, max=64, message="选择未能进行康复原因长度不能超过 64 个字符")
	public String getHip_5_1_5() {
		return hip_5_1_5;
	}

	public void setHip_5_1_5(String hip_5_1_5) {
		this.hip_5_1_5 = hip_5_1_5;
	}
	
	@Length(min=0, max=64, message="是否进行手术后镇痛治疗长度不能超过 64 个字符")
	public String getHip_5_2_1_1() {
		return hip_5_2_1_1;
	}

	public void setHip_5_2_1_1(String hip_5_2_1_1) {
		this.hip_5_2_1_1 = hip_5_2_1_1;
	}
	
	@Length(min=0, max=64, message="疼痛强度评估方法的选择长度不能超过 64 个字符")
	public String getHip_5_2_2_2() {
		return hip_5_2_2_2;
	}

	public void setHip_5_2_2_2(String hip_5_2_2_2) {
		this.hip_5_2_2_2 = hip_5_2_2_2;
	}
	
	@Length(min=0, max=64, message="其他疼痛强度评估方法长度不能超过 64 个字符")
	public String getHip_5_2_2_1() {
		return hip_5_2_2_1;
	}

	public void setHip_5_2_2_1(String hip_5_2_2_1) {
		this.hip_5_2_2_1 = hip_5_2_2_1;
	}
	
	@Length(min=0, max=64, message="药物选择多模式长度不能超过 64 个字符")
	public String getHip_5_2_3() {
		return hip_5_2_3;
	}

	public void setHip_5_2_3(String hip_5_2_3) {
		this.hip_5_2_3 = hip_5_2_3;
	}
	
	@Length(min=0, max=64, message="药物选择多模式填写长度不能超过 64 个字符")
	public String getHip_5_2_3_1() {
		return hip_5_2_3_1;
	}

	public void setHip_5_2_3_1(String hip_5_2_3_1) {
		this.hip_5_2_3_1 = hip_5_2_3_1;
	}
	
	@Length(min=0, max=64, message="镇痛用药多途径长度不能超过 64 个字符")
	public String getHip_5_2_4() {
		return hip_5_2_4;
	}

	public void setHip_5_2_4(String hip_5_2_4) {
		this.hip_5_2_4 = hip_5_2_4;
	}
	
	@Length(min=0, max=64, message="其他镇痛方法长度不能超过 64 个字符")
	public String getHip_5_2_4_1() {
		return hip_5_2_4_1;
	}

	public void setHip_5_2_4_1(String hip_5_2_4_1) {
		this.hip_5_2_4_1 = hip_5_2_4_1;
	}
	...
	public String getHip_6_1_2_1() {
		return hip_6_1_2_1;
	}

	public void setHip_6_1_2_1(String hip_6_1_2_1) {
		this.hip_6_1_2_1 = hip_6_1_2_1;
	}
	
	@Length(min=0, max=64, message="肌肉骨骼系统术后并发症长度不能超过 64 个字符")
	public String getHip_6_1_2_2() {
		return hip_6_1_2_2;
	}

	public void setHip_6_1_2_2(String hip_6_1_2_2) {
		this.hip_6_1_2_2 = hip_6_1_2_2;
	}
	
	@Length(min=0, max=64, message="骨科植入物的并发症长度不能超过 64 个字符")
	public String getHip_6_1_2_3() {
		return hip_6_1_2_3;
	}

	public void setHip_6_1_2_3(String hip_6_1_2_3) {
		this.hip_6_1_2_3 = hip_6_1_2_3;
	}
	
	@Length(min=0, max=64, message="是否伴有内科原有疾病治疗长度不能超过 64 个字符")
	public String getHip_6_2_1_1() {
		return hip_6_2_1_1;
	}

	public void setHip_6_2_1_1(String hip_6_2_1_1) {
		this.hip_6_2_1_1 = hip_6_2_1_1;
	}
	
	@Length(min=0, max=64, message="伴有主要的内科疾患长度不能超过 64 个字符")
	public String getHip_6_2_2() {
		return hip_6_2_2;
	}

	public void setHip_6_2_2(String hip_6_2_2) {
		this.hip_6_2_2 = hip_6_2_2;
	}
	
	@Length(min=0, max=64, message="其他系统疾病长度不能超过 64 个字符")
	public String getHip_6_2_2_1() {
		return hip_6_2_2_1;
	}

	public void setHip_6_2_2_1(String hip_6_2_2_1) {
		this.hip_6_2_2_1 = hip_6_2_2_1;
	}
	...
	@Length(min=0, max=64, message="入院宣教长度不能超过 64 个字符")
	public String getHip_7_1_1() {
		return hip_7_1_1;
	}

	public void setHip_7_1_1(String hip_7_1_1) {
		this.hip_7_1_1 = hip_7_1_1;
	}
	
	@Length(min=0, max=64, message="术前一日的健康教育长度不能超过 64 个字符")
	public String getHip_7_1_2() {
		return hip_7_1_2;
	}

	public void setHip_7_1_2(String hip_7_1_2) {
		this.hip_7_1_2 = hip_7_1_2;
	}
	
	@Length(min=0, max=64, message="术后六小时内的健康教育长度不能超过 64 个字符")
	public String getHip_7_1_3() {
		return hip_7_1_3;
	}

	public void setHip_7_1_3(String hip_7_1_3) {
		this.hip_7_1_3 = hip_7_1_3;
	}
	
	@Length(min=0, max=64, message="术后六小时至二十四小时的健康教育长度不能超过 64 个字符")
	public String getHip_7_1_4() {
		return hip_7_1_4;
	}

	public void setHip_7_1_4(String hip_7_1_4) {
		this.hip_7_1_4 = hip_7_1_4;
	}
	
	@Length(min=0, max=64, message="术后一周内健康教育长度不能超过 64 个字符")
	public String getHip_7_1_5() {
		return hip_7_1_5;
	}

	public void setHip_7_1_5(String hip_7_1_5) {
		this.hip_7_1_5 = hip_7_1_5;
	}
	
	@Length(min=0, max=64, message="术后一周后健康教育长度不能超过 64 个字符")
	public String getHip_7_1_6() {
		return hip_7_1_6;
	}

	public void setHip_7_1_6(String hip_7_1_6) {
		this.hip_7_1_6 = hip_7_1_6;
	}
	
	@Length(min=0, max=64, message="为患者提供出院前健康教育长度不能超过 64 个字符")
	public String getHip_7_1_7() {
		return hip_7_1_7;
	}

	public void setHip_7_1_7(String hip_7_1_7) {
		this.hip_7_1_7 = hip_7_1_7;
	}
