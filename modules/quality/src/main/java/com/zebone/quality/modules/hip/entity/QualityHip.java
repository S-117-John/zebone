...
public class QualityHip extends DataEntity<QualityHip> {
	...
	private Date hip_3_2_4;		// 预防深静脉栓塞医嘱执行起始日期
	private String hip_3_3_1_1;		// 基本预防措施
	private Date hip_3_3_2;		// 基本预防措施日期时间
	private String hip_3_3_3;		// 机械预防措施
	private Date hip_3_3_4;		// 机械预防措施日期时间
	private String hip_3_3_5;		// 预防性地给予药物的选择
	private String hip_3_3_5_1;		// 其它预防性地给予药物
	private Date hip_3_3_6;		// 预防性地给予药物日期时间
	...
	private Date hip_5_1_4;		// 康复实施日期(首次)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getHip_3_2_4() {
		return hip_3_2_4;
	}

	public void setHip_3_2_4(Date hip_3_2_4) {
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getHip_3_3_2() {
		return hip_3_3_2;
	}

	public void setHip_3_3_2(Date hip_3_3_2) {
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getHip_3_3_4() {
		return hip_3_3_4;
	}

	public void setHip_3_3_4(Date hip_3_3_4) {
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getHip_3_3_6() {
		return hip_3_3_6;
	}

	public void setHip_3_3_6(Date hip_3_3_6) {
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getHip_5_1_4() {
		return hip_5_1_4;
	}

	public void setHip_5_1_4(Date hip_5_1_4) {
