...
public class AsdDO extends DataEntity{
    ...
    private String asd_1_1_1;
    @Column(columnDefinition = "double COMMENT '左室射血分数（LVEF）测量值（%）'")
    private Double asd_1_1_2;
    @Column(columnDefinition = "varchar(64) COMMENT '左室射血分数（LVEF）评估结果的分层'")
    private String asd_1_1_2_1;
    @Column(columnDefinition = "varchar(64) COMMENT '房间隔缺损分型'")
    private String asd_1_1_3;
    @Column(columnDefinition = "double COMMENT 'ASD 的最大直径(mm)'")
    private Double asd_1_1_6_2;
    @Column(columnDefinition = "double COMMENT 'ASD 的最小直径(mm)'")
    private Double asd_1_1_6_1;
    @Column(columnDefinition = "varchar(64) COMMENT '多普勒血流'")
    private String asd_1_1_4;
    @Column(columnDefinition = "varchar(64) COMMENT '其他'")
    private String asd_1_1_5;
    @Column(columnDefinition = "varchar(64) COMMENT '是否实施手术前的心导管检查评估'")
    private String asd_1_2_1;
    @Column(columnDefinition = "double COMMENT '肺循环血量'")
    private Double asd_1_2_2_1;
    @Column(columnDefinition = "double COMMENT '体循环血量'")
    private Double asd_1_2_2_2;
    @Column(columnDefinition = "double COMMENT '肺循环血量/体循环血量比值(QP/QS)'")
    private Double asd_1_2_2;
    @Column(columnDefinition = "varchar(64) COMMENT 'ASD适应证'")
    private String asd_2_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '其他ASD适应证'")
    private String asd_2_1_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '手术方法的选择'")
    private String asd_2_1_2;
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '住院患者/患儿家长发生压疮'")
    private String cm_2_3_14;
    @Column(columnDefinition = "varchar(64) COMMENT '循环系统术后并发症'")
    private String cm_2_3_15;
    @Column(columnDefinition = "varchar(64) COMMENT '心脏和血管植入物的并发症'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '患者/患儿家长推荐'")
