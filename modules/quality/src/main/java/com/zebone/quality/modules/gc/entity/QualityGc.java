...
@Table(name="quality_gc", alias="a", columns={
		...
		@Column(name="cm_2_2_1", attrName="cm_2_2_1", label="胃癌手术特指的并发症"),
...
public class QualityGc extends DataEntity<QualityGc> {
	...
	private Date gc_8_2_3;		// 二次手术开始（切皮）日期时间
	private Date gc_8_2_4;		// 二次手术结束（缝皮结束）日期时间
	...
	@Length(min=0, max=64, message="胃癌手术特指的并发症长度不能超过 64 个字符")
	public String getCm_2_2_1() {
		return cm_2_2_1;
	}

	public void setCm_2_2_1(String cm_2_2_1) {
		this.cm_2_2_1 = cm_2_2_1;
	}
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getGc_8_2_3() {
		return gc_8_2_3;
	}

	public void setGc_8_2_3(Date gc_8_2_3) {
		this.gc_8_2_3 = gc_8_2_3;
	}
	
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getGc_8_2_4() {
		return gc_8_2_4;
	}

	public void setGc_8_2_4(Date gc_8_2_4) {
