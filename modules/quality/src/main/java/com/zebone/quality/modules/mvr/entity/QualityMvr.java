...
public class QualityMvr extends DataEntity<QualityMvr> {
	...
	private String mvr_3_2_2;		// 体外循环起始日期时间
	private String mvr_3_2_3;		// 体外循环结朿日期时间
	...
	private String mvr_3_5_2;		// 起始日期时间
	private String mvr_3_5_3;		// 终止日期时间
	...
	private String mvr_5_2_3;		// 再手术起始日期时间
	...
	@Length(min=0, max=64, message="体外循环起始日期时间长度不能超过 64 个字符")
	public String getMvr_3_2_2() {
		return mvr_3_2_2;
	}

	public void setMvr_3_2_2(String mvr_3_2_2) {
		this.mvr_3_2_2 = mvr_3_2_2;
	}
	
	@Length(min=0, max=64, message="体外循环结朿日期时间长度不能超过 64 个字符")
	public String getMvr_3_2_3() {
		return mvr_3_2_3;
	}

	public void setMvr_3_2_3(String mvr_3_2_3) {
	...
	public String getMvr_3_5_2() {
		return mvr_3_5_2;
	}

	public void setMvr_3_5_2(String mvr_3_5_2) {
		this.mvr_3_5_2 = mvr_3_5_2;
	}
	
	@Length(min=0, max=64, message="终止日期时间长度不能超过 64 个字符")
	public String getMvr_3_5_3() {
		return mvr_3_5_3;
	}

	public void setMvr_3_5_3(String mvr_3_5_3) {
	...
	public String getMvr_5_2_3() {
		return mvr_5_2_3;
	}

	public void setMvr_5_2_3(String mvr_5_2_3) {
