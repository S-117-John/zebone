...
public class Bc implements Serializable {
    ...
    @JSONField(name="BC-0-1-5")
    private String bc_0_1_5;
    @JSONField(name="BC-0-1-5-1")
    ...
    @JSONField(name="BC-1-1-1")
    private String bc_1_1_1;
    @JSONField(name="BC-1-1-2")
    private String bc_1_1_2;
    @JSONField(name="BC-1-1-3")
    private String bc_1_1_3;
    @JSONField(name="BC-1-2-1")
    private String bc_1_2_1;
    @JSONField(name="BC-1-2-2")
    private String bc_1_2_2;
    @JSONField(name="BC-1-3-1")
    private String bc_1_3_1;
    @JSONField(name="BC-2-1-1")
    private String bc_2_1_1;
    @JSONField(name="BC-2-1-2")
    private String bc_2_1_2;
    @JSONField(name="BC-2-1-2-1")
    private String bc_2_1_2_1;
    @JSONField(name="BC-2-1-3")
    private String bc_2_1_3;
    @JSONField(name="BC-2-1-3-1")
    private String bc_2_1_3_1;
    @JSONField(name="BC-2-1-4")
    private String bc_2_1_4;
    @JSONField(name="BC-2-1-4-1")
    private String bc_2_1_4_1;
    @JSONField(name="BC-2-2-1")
    private String bc_2_2_1;
    @JSONField(name="BC-2-2-2")
    private String bc_2_2_2;
    @JSONField(name="BC-2-2-3")
    private String bc_2_2_3;
    @JSONField(name="BC-2-2-4")
    private String bc_2_2_4;
    @JSONField(name="BC-3-1-1")
    private String bc_3_1_1;
    @JSONField(name="BC-3-1-2")
    private String bc_3_1_2;
    @JSONField(name="BC-3-1-2-1")
    private String bc_3_1_2_1;
    @JSONField(name="BC-3-1-3")
    private String bc_3_1_3;
    @JSONField(name="BC-3-1-4")
    private String bc_3_1_4;
    @JSONField(name="BC-3-1-5")
    private String bc_3_1_5;
    @JSONField(name="BC-3-3-1")
    private String bc_3_3_1;
    @JSONField(name="BC-3-2-1")
    private String bc_3_2_1;
    @JSONField(name="BC-3-2-2")
    private String bc_3_2_2;
    @JSONField(name="BC-3-2-2-1")
    private String bc_3_2_2_1;
    @JSONField(name="BC-3-2-3")
    private String bc_3_2_3;
    @JSONField(name="BC-4-1-1")
    private String bc_4_1_1;
    @JSONField(name="BC-4-1-2")
    private String bc_4_1_2;
    @JSONField(name="BC-4-1-3")
    private String bc_4_1_3;
    @JSONField(name="BC-4-1-3-1")
    private Double bc_4_1_3_1;
    @JSONField(name="BC-4-1-3-2")
    private Double bc_4_1_3_2;
    @JSONField(name="BC-4-1-4")
    private String bc_4_1_4;
    @JSONField(name="BC-4-1-4-1")
    private String bc_4_1_4_1;
    @JSONField(name="BC-4-1-4-2")
    private String bc_4_1_4_2;
    @JSONField(name="BC-4-1-5")
    private String bc_4_1_5;
    @JSONField(name="BC-4-2-1")
    private String bc_4_2_1;
    @JSONField(name="BC-4-2-2")
    private String bc_4_2_2;
    @JSONField(name="BC-4-2-3")
    private String bc_4_2_3;
    @JSONField(name="BC-4-2-4")
    ...
    public Date getBc_6_2_2() {
        return bc_6_2_2;
    }

    public void setBc_6_2_2(Date bc_6_2_2) {
        this.bc_6_2_2 = bc_6_2_2;
    }

    public Date getBc_6_2_3() {
        return bc_6_2_3;
    }

    public void setBc_6_2_3(Date bc_6_2_3) {
