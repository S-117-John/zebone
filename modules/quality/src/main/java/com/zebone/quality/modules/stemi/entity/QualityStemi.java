...
@Table(name="quality_stemi", alias="a", columns={
		...
		@Column(name="cm0141", attrName="cm0141", label="主要手术操作栏中提取ICD-9-CM-3四位亚目编码与名称"),
		...
		@Column(name="cm521", attrName="cm521", label="医院整体评级"),
...
public class QualityStemi extends DataEntity<QualityStemi> {
	...
	@Length(min=0, max=32, message="出院诊断ICD-10四位亚目编码与名称长度不能超过 32 个字符")
	...
	@Length(min=0, max=32, message="出院诊断ICD-10六位临床扩展编码与名称长度不能超过 32 个字符")
	...
	@Length(min=0, max=32, message="医院整体评级长度不能超过 32 个字符")
