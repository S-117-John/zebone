...
import com.zebone.quality.modules.dg.dao.QualityDgPatientDao;
...
public class QualityDgController extends BaseController {
    ...
    @Autowired
    private QualityDgPatientDao qualityDgPatientDao;
	 ...
	 */
	@ModelAttribute
	public QualityDg get(String id, boolean isNewRecord) throws InvocationTargetException, IllegalAccessException {
        if(!StringUtils.isEmpty(id)&&!isNewRecord){
            Map<String,Object> result = qualityDgService.findById(id);
            QualityDg qualityDg = new QualityDg();
            BeanUtils.populate(qualityDg,result);
            return qualityDg;
        }else {
	...
	public String form(QualityDg qualityDg, Model model) {
        if(StringUtils.isEmpty(qualityDg.getId())){
            qualityDg.setCm_1_6_2("a");

            qualityDg.setCm_5_1("y");
            qualityDg.setCm_5_2_1("a");
            qualityDg.setCm_5_2_2("a");
            qualityDg.setCm_5_2_3("a");
            qualityDg.setCm_5_2_5("a");
            qualityDg.setCm_5_2_6("a");
            qualityDg.setCm_5_2_7("a");
            qualityDg.setCm_5_2_8("a");
            qualityDg.setCm_5_2_9("a");
            qualityDg.setCm_5_2_10("a");
            qualityDg.setCm_5_2_11("a");

            //默认费用
            qualityDg.setCm_6_1(0.0);
            qualityDg.setCm_6_2(0.0);
            qualityDg.setCm_6_3(0.0);
            qualityDg.setCm_6_4(0.0);
            qualityDg.setCm_6_5(0.0);
            qualityDg.setCm_6_6(0.0);
            qualityDg.setCm_6_7(0.0);
            qualityDg.setCm_6_8(0.0);
            qualityDg.setCm_6_9(0.0);
            qualityDg.setCm_6_10(0.0);
            qualityDg.setCm_6_11(0.0);
            qualityDg.setCm_6_12(0.0);
            qualityDg.setCm_6_13(0.0);
            qualityDg.setCm_6_14(0.0);
            qualityDg.setCm_6_15(0.0);
            qualityDg.setCm_6_16(0.0);
            qualityDg.setCm_6_17(0.0);
            qualityDg.setCm_6_18(0.0);
            qualityDg.setCm_6_19(0.0);
            qualityDg.setCm_6_20(0.0);
            qualityDg.setCm_6_21(0.0);
            qualityDg.setCm_6_22(0.0);
            qualityDg.setCm_6_23(0.0);
            qualityDg.setCm_6_24(0.0);
            qualityDg.setCm_6_25(0.0);
            qualityDg.setCm_6_26(0.0);
            qualityDg.setCm_6_27(0.0);
            qualityDg.setCm_6_28(0.0);
            qualityDg.setCm_6_29(0.0);
            qualityDg.setCm_6_30(0.0);
        }
		model.addAttribute("qualityDg", qualityDg);
	...
	public String save(@Validated QualityDg qualityDg) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		//处理caseid多选节点
        if (!StringUtils.isEmpty(qualityDg.getCaseid())){
            if (("").equals(qualityDg.getCaseid().split(",")[0])){
                qualityDg.setCaseid(qualityDg.getCaseid().split(",")[1]);
    ...
    public String empUserSelect(EmpUser empUser, String selectData, String checkbox, Model model) {
        ...
        return "modules/dg/patientSelect";
    }
    ...
    public List<Patient> patientListData(Patient patientParam, HttpServletRequest request, HttpServletResponse response) {
        ...
        List<Patient> patients = qualityDgPatientDao.list(param);
