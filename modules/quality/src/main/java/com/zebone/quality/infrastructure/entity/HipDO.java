...
public class HipDO extends DataEntity{
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '其他手术操作栏中提取ICD-9-CM-3六位临床扩展编码与名称'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '人工髋关节置换术适应证'")
    private String hip_1_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '其他骨关节疾患填写'")
    private String hip_1_1_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '病变侧别'")
    private String hip_1_1_2;
    @Column(columnDefinition = "varchar(64) COMMENT '是否实施髋关节功能评估'")
    private String hip_1_2_1;
    @Column(columnDefinition = "double COMMENT '左Harris评分值'")
    private Double hip_1_2_2_2;
    @Column(columnDefinition = "varchar(64) COMMENT '左侧评估结果的分层'")
    private String hip_1_2_2_4;
    @Column(columnDefinition = "double COMMENT '右Harris评分值'")
    private Double hip_1_2_2_1;
    @Column(columnDefinition = "varchar(64) COMMENT '右侧评估结果的分层'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '其他决定手术方案的医师资质'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '有无实施预防术后深静脉血栓措施的禁忌'")
    private String hip_3_2_1;
    @Column(columnDefinition = "varchar(64) COMMENT '实施药物预防措施绝对禁忌证'")
    private String hip_3_2_2_1;
    @Column(columnDefinition = "varchar(64) COMMENT '实施药物预防措施相对禁忌证'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '出院后继续使用其它抗凝药'")
    private String hip_3_4_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '是否实施输血'")
    private String hip_4_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '临床用血类别'")
    private String hip_4_2_1;
    @Column(columnDefinition = "varchar(64) COMMENT '输血部位'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '是否康复治疗前评估'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '药物选择多模式'")
    private String hip_5_2_3;
    @Column(columnDefinition = "varchar(64) COMMENT '药物选择多模式填写'")
    private String hip_5_2_3_1;
    @Column(columnDefinition = "varchar(64) COMMENT '镇痛用药多途径'")
    private String hip_5_2_4;
    @Column(columnDefinition = "varchar(64) COMMENT '其他镇痛方法'")
    ...
    @Column(columnDefinition = "varchar(64) COMMENT '伴有主要的内科疾患'")
    private String hip_6_2_2;
    @Column(columnDefinition = "varchar(64) COMMENT '其他系统疾病'")
    private String hip_6_2_2_1;
    @Column(columnDefinition = "varchar(64) COMMENT '影响程度的选择'")
    private String cm_2_4;
    @Column(columnDefinition = "varchar(64) COMMENT '入院宣教'")
    private String hip_7_1_1;
    @Column(columnDefinition = "varchar(64) COMMENT '术前一日的健康教育'")
